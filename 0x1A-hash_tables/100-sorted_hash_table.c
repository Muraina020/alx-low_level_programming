...
/**
 * add_to_sorted_list - This add a node to the sorted (by key's ASCII) linked list
...
/**
 * shash_table_get - This retrieve a value from the hash table
 * @ht: hash table
 * @key: key to the data
 *
...
{
	shash_node_t *tmp;
	char flag = 0; /* 0 before any data will be printed, 1 after*/
